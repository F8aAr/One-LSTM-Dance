...
*We have uploaded the weights of a trained model
## Train a new model
...
*We have uploaded the Text_corpus, you just have to assign it to the variable path....  path = 'GS_QUAD_MDF_sel.txt'
